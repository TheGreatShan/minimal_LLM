...
public class RunLlama : IRun
{
    ...
    public async Task Run()
    {
        ...
        Console.WriteLine(
            $"The executor has been enabled. In this example, the prompt is printed, the maximum tokens is set to {llama.InferenceParams.MaxTokens} (an example for medium scale usage) {llama.ModelParams.ContextSize} Max context size");
